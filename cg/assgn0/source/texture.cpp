...
int texture(Object obj){
    ...
    glShaderSource(vertexShader, 1, &texture_vertexShaderSource, NULL);
    ...
    glShaderSource(fragmentShader, 1, &texture_fragmentShaderSource, NULL);
    ...
    unsigned char *data = stbi_load("../source/texture.jpg", &width, &height, &nrChannels, 0);
    if (data) {
